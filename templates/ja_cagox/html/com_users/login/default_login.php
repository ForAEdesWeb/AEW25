  ...
  <div class="login <?php echo $this->pageclass_sfx?>">
      ...
      <fieldset>
		...
		<div class="login-image">
  			<img src="<?php echo $this->escape($this->params->get('login_image')); ?>" alt="<?php echo JTEXT::_('COM_USER_LOGIN_IMAGE_ALT')?>"/>
		</div>
  		<?php endif; ?>
