...
namespace Copymodules\Component;

use Copymodules\Provider\CopymodulesProvider;
 ...
 * @since 1.0
 */
abstract class CopymodulesComponent extends Component
{
	/**
	...
	public function prepare()
	{
		...
		// Register provider
		$this->container->registerServiceProvider(new CopymodulesProvider);
