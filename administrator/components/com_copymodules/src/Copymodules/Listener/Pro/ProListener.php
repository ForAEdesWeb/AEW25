...
namespace Copymodules\Listener\Pro;
...
class ProListener extends \JEvent
{
	...
	public function onToolbarAppendButton($context, $args = array())
	{
		...
		switch($context){
			case 'preferences' :
				...
				$args[] = 'administrator/components/com_copymodules/includes/plugins/pro' ;
				break;
		}
		*/
	}
	...
	/**
	 * Copymodules prepare content method
	...
	/**
	 * Copymodules after display title method
	...
	/**
	 * Copymodules before display content method
	 * Method is called by the view and the results are imploded and displayed in a placeholder
	 *
	 * @param   string $context The context of the content being passed to the plugin.
	 * @param   object $article The content object.  Note $article->text is also available.
	...
	/**
	 * Copymodules after display content method
	 * Method is called by the view and the results are imploded and displayed in a placeholder
	 *
	 * @param   string $context The context of the content being passed to the plugin.
	 * @param   object $article The content object.  Note $article->text is also available.
	...
	/**
	 * Copymodules before save content method
	...
	/**
	 * Copymodules after save content method
	...
	/**
	 * Copymodules before delete method.
	 *
	...
	/**
	 * Copymodules after delete method.
	 *
	 * @param   string $context The context for the content passed to the plugin.
	 * @param   object $data    The data relating to the content that is to be deleted.
	 *
	...
	/**
	 * Copymodules on change state method.
	 *
	 * @param   string $context The context for the content passed to the plugin.
